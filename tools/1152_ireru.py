...
TAMA = [
    ...
    # ★1163番（2026-09-26）たまごさんから追加で貼られた1本。同じ aya_bistro の別投稿。
    #   関所：cdn.syndication 200／oEmbed 200／動画あり／サムネ200（status/1163/thumb/5_aya2.jpg
    #   を実際に開いて見た＝白い皿に淡い黄色のスープを注いでいる。画面に「材料2つ ミキサーいらず」）。
    #   「スープ」と断定できる根拠：**投稿者本人が「ミキサーいらずのスープレシピ」
    #   「冷製ビシソワーズの、一番簡単なレシピです」と書いている。**
    {
        "key": "vichy-x",
        "url": "https://x.com/aya_bistro/status/2103643834483900725",
        "shelves": [("food", None, "スープ")],
        "title": "ミキサーを出す前に、ビシソワーズができてしまった",
        "whisper": "じゃがいもと牛乳、それだけ。道具を出しに行く手間のほうが長い。",
        "memo": "食＞スープ",
        "channel": "あやシェフ",
        "material": "冷製ビシソワーズ／ミキサーいらず／じゃがいも（皮つきで300g）・牛乳300ml・"
                    "コンソメ・塩こしょう／白い皿に注がれる淡い黄色のスープ／あやシェフ",
    },
]
